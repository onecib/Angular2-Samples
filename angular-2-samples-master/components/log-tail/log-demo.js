System.register(['@angular/core', './store', './log-action', './log-entry', './log-tail-service'], function(exports_1, context_1) {
    "use strict";
